 ...
 */
package com.example.smart.client;
...
public class LoginClientController {
    ...
    public String login(@RequestParam("username") String username,
        ...
        try {
            ResponseEntity<LoginResponse> response = restTemplate.exchange(url + "login", HttpMethod.POST, request, LoginResponse.class);
            ...
            boolean hasTeacherRole = auth.getAuthorities().stream()
                    .anyMatch(r -> r.getAuthority().equals("TEACHER"));
